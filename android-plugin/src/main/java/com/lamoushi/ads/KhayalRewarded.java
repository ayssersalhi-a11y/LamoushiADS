...
public class KhayalRewarded extends GodotPlugin {
    ...
    public KhayalRewarded(Godot godot) {
        super(godot);
    ...
    private void installDiagnostics() {
        ...
        String js =
                "(function(){"
                        ...
                        + "if(window.__khayal_diag)"
                        + "return 'already';"

                        + "window.__khayal_diag=true;"
    ...
    private void installPopDiagnostics(
        ...
        String js =
                "(function(){"
                        ...
                        + "if(window.__khayal_pop_diag)"
                        + "return 'already';"

                        + "window.__khayal_pop_diag=true;"
